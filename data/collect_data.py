...
class DataCollector:
    def __init__(self, csv_name):
        ...
        self.club_ids = {
            club_name: i + 1 for i, club_name in enumerate(self.club_names)
        }
    ...
    def generate_training_and_test_data(self):
        ...
        input_columns = ["hora", "rodada"] + [
            f"id_{i + 1}" for i in range(len(self.club_ids))
        ]
        output_columns = [
            "bs",
            "mt1g",
        ...
        test_data = {"input": test[input_columns], "output": test[output_columns]}
        train_data = {"input": train[input_columns], "output": train[output_columns]}
