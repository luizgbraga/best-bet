...
def inputs():
    ...
    if request.method == "POST":
        ...
        input_data = data_processor.format_input_data(
            home_team_id, visit_team_id, hour, round
        )
    ...
    return render_template(
        "inputs.html",
        home_teams=data_collector.get_club_names(),
        visit_teams=data_collector.get_club_names(),
        hours=TimeConverter.all_times(),
    )
